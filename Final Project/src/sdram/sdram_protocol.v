...
// nand2mario
// 
// 2025.3: updated to 32bits din/dout ( 2M * 32 )
...
// on Tang Nano 20K. The SDRAM module is 64Mbit (8MBytes) 32bit. (2K rows x 256 columns x 4 banks x 32 bits).
//
// Under default settings (max 138.0Mhz):
...
module sdram_protocol
#(
    // Clock frequency, max 138.0Mhz with current set of T_xx/CAS parameters.
    ...
    // Time delays for 138.0Mhz max clock (min clock cycle 15ns)
...
(
    ...
    output reg                  SDRAM_nCS,    // not strictly necessary, always 0
    output reg                  SDRAM_nWE,
    output reg                  SDRAM_nRAS,
    output reg                  SDRAM_nCAS,
    output reg                  SDRAM_CLK,
    output reg                  SDRAM_CKE,    // not strictly necessary, always 1
